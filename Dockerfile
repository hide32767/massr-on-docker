...
RUN groupadd webapp
RUN useradd -g webapp -m -s /bin/dash webapp
...
RUN chmod 600 /home/webapp/.pit/*
RUN chown webapp:webapp /home/webapp/.pit/*

# creating a directory for web-app
RUN mkdir -m 755 /srv/webapp
...
RUN chmod 600 /srv/webapp/.env
RUN chown webapp:webapp /srv/webapp/.env
